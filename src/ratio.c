 ...
 *  inverse
 */
_g void inverse_fixnum_ratio_local(LocalRoot local, addr pos, addr *ret)
{
	int sign;
	bigtype value;
...
_g void inverse_bignum_ratio_local(LocalRoot local, addr pos, addr *ret)
{
	int sign;
	addr numer, denom;
...
_g void inverse_ratio_local(LocalRoot local, addr pos, addr *ret)
{
	int sign;
	addr numer, denom;
