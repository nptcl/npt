...
#define structure_class_p _n(structure_class_p)
#define structure_class_object_p _n(structure_class_object_p)
#define structure_instance_p _n(structure_instance_p)
