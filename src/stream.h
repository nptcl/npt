...
__extern LispStreamTypeArray(readf_binary);
...
__extern LispStreamTypeArray(file_charlen);
__extern LispStreamTypeArray(file_strlen);
...
__extern LispStreamTypeArray(termsize);
