...
_g int function_setf_values(Execute ptr, addr args, addr env);
_g int function_setf_getf(Execute ptr, addr args, addr env);
_g int function_setf_apply(Execute ptr, addr args, addr env);
