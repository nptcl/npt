...
#define ExecuteDefault(ptr) { \
	if (ptr == NULL) { \
		ptr = Execute_Thread; \
	} \
}

static int instance_condition_(Execute ptr, addr *ret, constindex condition)
{
	addr pos;
	GetConstant(condition, &pos);
	return clos_instance_heap_(ptr, pos, ret);
}

static int instance_condition1_(Execute ptr, addr *ret,
		constindex index, constindex index1, addr pos1)
{
	addr instance;

	GetConstant(index, &instance);
	Return(clos_instance_heap_(ptr, instance, &instance));
	Return(clos_setconst_(instance, index1, pos1));
	return Result(ret, instance);
}

static int instance_condition2_(Execute ptr, addr *ret,
		constindex index,
...
static int instance_condition4_(Execute ptr, addr *ret, constindex index,
		constindex index1, addr pos1,
		constindex index2, addr pos2,
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_SERIOUS_CONDITION);
}
...
int call_serious_condition_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_serious_condition_(ptr, &instance));
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_SIMPLE_CONDITION,
...
int call_simple_condition_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_condition_(ptr, &instance, control, args));
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_SIMPLE_ERROR,
			CONSTANT_CLOSNAME_FORMAT_CONTROL, control,
			CONSTANT_CLOSNAME_FORMAT_ARGUMENTS, args);
}
...
int call_simple_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_ERROR);
}
...
int call_error_condition_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_error_condition_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_WARNING);
}
...
int call_warning_condition_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_warning_condition_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_SIMPLE_WARNING,
			CONSTANT_CLOSNAME_FORMAT_CONTROL, control,
			CONSTANT_CLOSNAME_FORMAT_ARGUMENTS, args);
}
...
int call_simple_warning_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_warning_(ptr, &instance, control, args));
	return signal_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_STORAGE_CONDITION);
}
...
int call_storage_condition_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_storage_condition_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_ARITHMETIC_ERROR,
...
int call_arithmetic_error_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_arithmetic_error_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_FLOATING_POINT_INEXACT,
			CONSTANT_CLOSNAME_OPERATION, pos,
			CONSTANT_CLOSNAME_OPERANDS, list);
}
...
int call_float_inexact_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_float_inexact_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret,
...
int call_float_invalid_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_float_invalid_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_FLOATING_POINT_OVERFLOW,
			CONSTANT_CLOSNAME_OPERATION, pos,
			CONSTANT_CLOSNAME_OPERANDS, list);
}
...
int call_float_overflow_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_float_overflow_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
int instance_float_underflow_(Execute ptr, addr *ret, addr pos, addr list)
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_FLOATING_POINT_UNDERFLOW,
			CONSTANT_CLOSNAME_OPERATION, pos,
			CONSTANT_CLOSNAME_OPERANDS, list);
}
...
int call_float_underflow_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_float_underflow_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_DIVISION_BY_ZERO,
			CONSTANT_CLOSNAME_OPERATION, pos,
			CONSTANT_CLOSNAME_OPERANDS, list);
}
...
int call_division_by_zero_(Execute ptr, addr pos, addr list)
{
	...
	ExecuteDefault(ptr);
	Return(instance_division_by_zero_(ptr, &instance, pos, list));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_CELL_ERROR, CONSTANT_CLOSNAME_NAME, name);
}
...
int call_cell_error_(Execute ptr, addr name)
{
	...
	ExecuteDefault(ptr);
	Return(instance_cell_error_(ptr, &instance, name));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_CONTROL_ERROR);
}
...
int call_control_error_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_control_error_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_STREAM_ERROR, CONSTANT_CLOSNAME_STREAM, stream);
}
...
int call_stream_error_(Execute ptr, addr stream)
{
	...
	ExecuteDefault(ptr);
	Return(instance_stream_error_(ptr, &instance, stream));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_END_OF_FILE, CONSTANT_CLOSNAME_STREAM, stream);
}
...
int call_end_of_file_(Execute ptr, addr stream)
{
	...
	ExecuteDefault(ptr);
	Return(instance_end_of_file_(ptr, &instance, stream));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_READER_ERROR, CONSTANT_CLOSNAME_STREAM, stream);
}
...
int call_reader_error_(Execute ptr, addr stream)
{
	...
	ExecuteDefault(ptr);
	Return(instance_reader_error_(ptr, &instance, stream));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_FILE_ERROR, CONSTANT_CLOSNAME_PATHNAME, pathname);
}
...
int call_file_error_(Execute ptr, addr pathname)
{
	...
	ExecuteDefault(ptr);
	Return(instance_file_error_(ptr, &instance, pathname));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_PACKAGE_ERROR, CONSTANT_CLOSNAME_PACKAGE, package);
}
...
int call_package_error_(Execute ptr, addr package)
{
	...
	ExecuteDefault(ptr);
	Return(instance_package_error_(ptr, &instance, package));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_PARSE_ERROR);
}
...
int call_parse_error_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_parse_error_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_PRINT_NOT_READABLE, CONSTANT_CLOSNAME_OBJECT, object);
}
...
int call_print_not_readable_(Execute ptr, addr object)
{
	...
	ExecuteDefault(ptr);
	Return(instance_print_not_readable_(ptr, &instance, object));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_PROGRAM_ERROR);
}
...
int call_program_error_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_program_error_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_STYLE_WARNING);
}
...
int call_style_warning_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_style_warning_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_TYPE_ERROR,
...
int call_type_error_(Execute ptr, addr datum, addr expected)
{
	...
	Return(instance_type_error_(ptr, &instance, datum, expected));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition4_(ptr, ret, CONSTANT_CONDITION_SIMPLE_TYPE_ERROR,
			CONSTANT_CLOSNAME_FORMAT_CONTROL, control,
			CONSTANT_CLOSNAME_FORMAT_ARGUMENTS, args,
			CONSTANT_CLOSNAME_DATUM, datum,
			CONSTANT_CLOSNAME_EXPECTED_TYPE, expected);
		...
		addr control, addr args, addr datum, addr expected)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_type_error_(ptr, &instance, control, args, datum, expected));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition2_(ptr, ret, CONSTANT_CONDITION_UNBOUND_SLOT,
...
int call_unbound_slot_(Execute ptr, addr argument, addr name)
{
	...
	ExecuteDefault(ptr);
	Return(instance_unbound_slot_(ptr, &instance, argument, name));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_UNBOUND_VARIABLE, CONSTANT_CLOSNAME_NAME, name);
}
...
int call_unbound_variable_(Execute ptr, addr name)
{
	...
	ExecuteDefault(ptr);
	Return(instance_unbound_variable_(ptr, &instance, name));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_UNDEFINED_FUNCTION, CONSTANT_CLOSNAME_NAME, name);
}
...
int call_undefined_function_(Execute ptr, addr name)
{
	...
	ExecuteDefault(ptr);
	Return(instance_undefined_function_(ptr, &instance, name));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition_(ptr, ret, CONSTANT_CONDITION_SAVECORE);
}
...
int call_savecore_condition_(Execute ptr)
{
	...
	ExecuteDefault(ptr);
	Return(instance_savecore_condition_(ptr, &instance));
	return error_function_(ptr, instance);
}
...
{
	return instance_condition1_(ptr, ret,
			CONSTANT_CONDITION_EXIT, CONSTANT_CLOSNAME_VALUE, value);
}
...
int call_exit_condition_(Execute ptr, addr value)
{
	...
	ExecuteDefault(ptr);
	Return(instance_exit_condition_(ptr, &instance, value));
	return error_function_(ptr, instance);
}
...
int call_simple_control_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_control_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_file_error_(Execute ptr, addr pathname, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_file_error_(ptr, &instance, pathname, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_package_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_package_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_parse_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_parse_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_program_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_program_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_reader_error_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_reader_error_(ptr, &instance, control, args));
	return error_function_(ptr, instance);
}
...
int call_simple_style_warning_(Execute ptr, addr control, addr args)
{
	...
	ExecuteDefault(ptr);
	Return(instance_simple_style_warning_(ptr, &instance, control, args));
