...
CONSTANT_CODE_LOAD_TIME_VALUE_BIND,
CONSTANT_CODE_LOAD_TIME_VALUE_INIT,
...
CONSTANT_SYSTEM_SPECIAL_MAKE_LOAD_FORM,
CONSTANT_SYSTEM_COMPILE_MAKE_LOAD_FORM,
...
CONSTANT_SYSTEM_COMPILE_GENSYM,
CONSTANT_SYSTEM_COMPILE_GENSYM_INDEX,
