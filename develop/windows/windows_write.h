...
#define windows_write_return_lock _n(windows_write_return_lock)
...
#define windows_write_scroll_down_lock _n(windows_write_scroll_down_lock)
#define windows_write_scroll_up_lock _n(windows_write_scroll_up_lock)
