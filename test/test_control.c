 ...
 *  Main
 */
static int testcase_control(void)
{
	/* taginfo */
...
static void testinit_control(Execute ptr)
{
	build_lisproot(ptr);
	build_constant();
	build_object();
