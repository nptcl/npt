...
static int test_array_initial(void)
{
	...
	str->element = sizeoft(unicode);
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_initial(pos, characterh(100));
	GetArrayInfo(pos, ARRAY_INDEX_MEMORY, &mem);
	data = (long_float *)arrayspec_ptr(mem);
...
static int test_array_setindex(void)
{
	...
	str->element = sizeoft(unicode);
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_setindex(pos, 9, characterh(100));
	GetArrayInfo(pos, ARRAY_INDEX_MEMORY, &mem);
	data = (long_float *)arrayspec_ptr(mem);
...
static int test_aref_character_index_array(void)
{
	...
	str->element = sizeoft(unicode);
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_initial(pos, characterh(0));
	array_setindex(pos, 10, characterh(10));
	array_setindex(pos, 12, characterh(20));
	array_setindex(pos, 15, characterh(3333));
	test_aref_array_memory(pos, 9, &value);
...
static int test_aref_single_float_index_array(void)
{
	...
	str->size = 20;
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_initial(pos, singleh(11.0f));
	array_setindex(pos, 10, singleh(10.0f));
	array_setindex(pos, 12, singleh(20.0f));
	test_aref_array_memory(pos, 9, &value);
...
static int test_aref_double_float_index_array(void)
{
	...
	str->size = 20;
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_initial(pos, doubleh(11.0));
	array_setindex(pos, 10, doubleh(10.0));
	array_setindex(pos, 12, doubleh(20.0));
	test_aref_array_memory(pos, 9, &value);
...
static int test_aref_long_float_index_array(void)
{
	...
	str->size = 20;
	array_make_memory(NULL, pos, Nil, Nil, Nil, Nil);
	array_initial(pos, longh(11.0L));
	array_setindex(pos, 10, longh(10.0L));
	array_setindex(pos, 12, longh(20.0L));
	test_aref_array_memory(pos, 9, &value);
